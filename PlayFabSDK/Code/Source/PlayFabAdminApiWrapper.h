...
namespace PlayFab
{
    ...
    public:
        ...
        void SetStoreSegmentOverrides(AdminModels::SetStoreSegmentOverridesRequest& request, ProcessApiCallback<AdminModels::SetStoreSegemntOverridesResult> callback = nullptr, ErrorCallback errorCallback = nullptr, void* customData = nullptr) override;
